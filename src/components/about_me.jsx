                ...
                <div id="about_outside_div">
                    <div id="about_me_container">
                        <div id="about_me_text_container">
                            <p id="header_main" class='about_text'>Telesat LEO</p>
                            ...
                            With experience in various industries, including aviation, satellite, drone technology, web development, and ship engineering,
